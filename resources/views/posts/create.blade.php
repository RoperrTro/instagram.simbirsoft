        ...
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                <div class="panel panel-default">
                    <div class="panel-heading">Создание записи</div>
                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" method="POST" enctype="multipart/form-data" action="{{ route('posts.store') }}">
                            ...
                            <div class="form-group{{ $errors->has('place') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="location" type="text" class="form-control" name="place" maxlength="255" value="{{ old('place') }}" required autofocus>
                        ...
                        <div class="form-group">
                            <div class="col-md-8 col-md-offset-4">
                                <a type="submit" class="btn alert-danger" href="/home">
                                    Отменить
                                </a>
                            </div>
                        </div>
